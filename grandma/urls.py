...
urlpatterns += patterns(
    ...
    url(r'^started/(?P<task_id>\d{1,7})/$', 'grandma.views.started', name='started'),
    ...
    url(r'^cancel_lock/(?P<task_id>\d{1,7})/$', 'grandma.views.cancel_lock', name='cancel_lock'),
    url(r'^create_superuser/$', 'grandma.views.create_superuser', name='create_superuser'),
